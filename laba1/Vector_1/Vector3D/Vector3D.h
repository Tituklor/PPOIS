 ...
 * 
 * Вектор задается координатами начала (x1, y1, z1) и конца (x2, y2, z2).
 * Все векторные операции выполняются над направляющими векторами
 * (разностью координат конца и начала).
 * 
